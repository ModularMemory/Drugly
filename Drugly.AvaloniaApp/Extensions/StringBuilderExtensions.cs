...
/// <summary>Provides extensions for <see cref="StringBuilder"/>s.</summary>
public static class StringBuilderExtensions
{
    extension(StringBuilder sb)
    {
        /// <summary>Removes all trailing occurrences of a character.</summary>
        ...
        /// <summary>Removes all trailing occurrences of a set of characters.</summary>
